...
from adam_o1.adam_o1_graph import agentic_flow
...
def reload_adam_o1_graph():
    """Reload the adam_o1_graph module to apply new environment variables"""
    try:
        # First reload pydantic_ai_coder
        import adam_o1.pydantic_ai_coder
        importlib.reload(adam_o1.pydantic_ai_coder)
        
        # Then reload adam-o1_graph which imports pydantic_ai_coder
        import adam_o1.adam_o1_graph
        importlib.reload(adam_o1.adam_o1_graph)
...
def intro_tab():
    ...
    st.image("public/adam_o1.png", use_container_width=True)
            ...
            with col1:
                ...
                if st.button("Crawl Pydantic AI Docs", key="crawl_pydantic") and not (st.session_state.crawl_tracker and st.session_state.crawl_tracker.is_running):
                    try:
                        ...
                        from adam_o1.crawl_pydantic_ai_docs import start_crawl_with_requests
                ...
                if st.button("Clear Pydantic AI Docs", key="clear_pydantic"):
                    with st.spinner("Clearing existing Pydantic AI docs..."):
                        try:
                            ...
                            from adam_o1.crawl_pydantic_ai_docs import clear_existing_records
...
async def main():
    ...
    with st.sidebar:
        st.image("public/adam_o1.png", width=200)
