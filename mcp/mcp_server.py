...
async def create_thread() -> str:
    """Create a new conversation thread for Adam-o1.
    Always call this tool before invoking Adam-o1 for the first time in a conversation.
...
async def run_agent(thread_id: str, user_input: str) -> str:
    """Run the Adam-o1 agent with user input.
    ...
    After you receive the code from Adam-o1, always implement it into the codebase unless asked not to.
